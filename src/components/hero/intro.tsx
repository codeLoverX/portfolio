...
export default function Intro() {
  return (
    <div className='top-0 flex w-screen items-center justify-evenly lg:absolute lg:h-screen'>
      <div className='w-full'>
        <div className='container mx-auto grid w-9/12 grid-cols-3 text-center lg:w-7/12 lg:text-start'>
          ...
          <div className='order-1 col-span-3 lg:order-2 lg:col-span-1'>
            <div className='avatar pt-12 lg:pt-0'>
              <div className='lg:96 mask mask-squircle w-72'>
                <Image
                  alt='hi'
                  className=''
                  width='250'
        ...
        <div>
          <div className='container m-auto w-9/12 pt-6 text-center text-lg lg:w-7/12 lg:pt-0 lg:text-start'>
            <div className='pt-0 lg:pt-6'>
              <p className='align-center mx-auto mb-2 w-6/12 border-b-2 border-b-black border-r-black pb-2 pr-0 lg:mr-4 lg:inline lg:border-r-2 lg:border-b-0 lg:pr-4'>
                Frontend
              </p>
              ...
              <p className='align-center mr-0 mb-2 pb-2 pr-0 lg:mr-12 lg:inline lg:pr-12'>
                ...
                <SiGraphql className='ml-2 inline fill-blue-600 text-3xl hover:fill-blue-600' />
              </p>
            </div>
            <div className='pt-0 lg:pt-6'>
              <p className='align-center mx-auto mb-2 w-6/12 border-b-2 border-b-black border-r-black pb-2 pr-0 lg:mr-4 lg:inline lg:border-r-2 lg:border-b-0 lg:pr-4'>
